...
object base_opcode {
  // 000
  val LOAD = Cat("b00".U, "b000".U, "b11".U)
  val STORE = Cat("b01".U, "b000".U, "b11".U)
  val MADD = Cat("b10".U, "b000".U, "b11".U)
  val BRANCH = Cat("b11".U, "b000".U, "b11".U)
  // 001
  val LOAD_FP = Cat("b00".U, "b001".U, "b11".U)
  val STORE_FP = Cat("b01".U, "b001".U, "b11".U)
  val MSUB = Cat("b10".U, "b001".U, "b11".U)
  val JALR = Cat("b11".U, "b001".U, "b11".U)
  // 010
  val CUSTOM_0 = Cat("b00".U, "b010".U, "b11".U)
  val CUSTOM_1 = Cat("b01".U, "b010".U, "b11".U)
  val NMSUB = Cat("b10".U, "b010".U, "b11".U)
  val RESERVED0 = Cat("b11".U, "b010".U, "b11".U)
  // 011
  val MISC_MEM = Cat("b00".U, "b011".U, "b11".U)
  val AMO = Cat("b01".U, "b011".U, "b11".U)
  val NMADD = Cat("b10".U, "b011".U, "b11".U)
  val JAL = Cat("b11".U, "b011".U, "b11".U)
  // 100
  val OP_IMM = Cat("b00".U, "b100".U, "b11".U)
  val OP = Cat("b01".U, "b100".U, "b11".U)
  val OP_FP = Cat("b10".U, "b100".U, "b11".U)
  val SYSTEM = Cat("b11".U, "b100".U, "b11".U)
  // 101
  val AUIPC = Cat("b00".U, "b101".U, "b11".U)
  val LUI = Cat("b01".U, "b101".U, "b11".U)
  val RESERVED1 = Cat("b10".U, "b101".U, "b11".U)
  val RESERVED2 = Cat("b11".U, "b101".U, "b11".U)
  // 110
  val OP_IMM_32 = Cat("b00".U, "b110".U, "b11".U)
  val OP_32 = Cat("b01".U, "b110".U, "b11".U)
  val CUSTOM_2 = Cat("b10".U, "b110".U, "b11".U)
  val RESERVED3 = Cat("b11".U, "b110".U, "b11".U)
}
